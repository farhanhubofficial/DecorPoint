...
<div className=" hidden lg:block font-bold text-yellow-800/100">
 <nav className=" flex justify-between items-center      text-lg gap-6 text-yellow-900   px-">
      ...
      <Link className="border-b-2 border-solid border-yellow-800 " to= '/Approach'><h1 className="ml-[-.4rem]  my-9">Our Approach</h1></Link>    
...
<IoMdClose className='text-2xl  mb-8 mt-0 cursor-pointer '
